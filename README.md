...
|:---:|:---|:---|:---|
| **1** | [AirBnb Rental Price Prediction](./Rental%20Prices%20of%20AirBnb) | Data preprocessing, Outlier analysis, Label encoding, Linear Regression | Regression |
| **2** | [Formula 1 Race Prediction](./Machine%20Learning%20F1%20Prediction) | Feature engineering, Class weight tuning, XGBoost, ROC-AUC evaluation | Classification |
| **3** | [Indonesian Social Media Toxicity](./Indonesian%20Social%20Media%20Toxicity%20Project) | EDA, Linear Regression, Random Forest Classifier & Regressor | Classification & Regression |
| **4** | [Spotify System Recommendation](./Spotify%20System%20Recomendation) | Content-Based Filtering, TF-IDF, Cosine Similarity | Recommendation System |
